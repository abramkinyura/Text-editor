...
public:
    ...
    void moveForward() throw (L2ListException) {
        if (inEnd()) {
    ...
    void moveBack() throw (L2ListException) {
        if (inBeg()) {
     ...
     */
    void removeBefore() throw (L2ListException) {
        if (inBeg()) {
     ...
     */
    void removeAfter() throw (L2ListException) {
        if (inEnd()) {
